      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Casas, cabañas, quinchos, terrazas, entre otros, pensadas para hacer realidad tus ideas, 
            con un enfoque en la calidad, el cumplimiento y la atención personalizada.
          </p>
        </div>
